  ...
  <div class="sidebar-wrapper">
    <ul class="nav">
      <li class="nav-item{{ $activePage == 'dashboard' ? ' active' : '' }}">
        ...
        <li class="nav-item{{ $activePage == 'tokens' ? ' active' : '' }}">
            <a class="nav-link" href="{{ route('tokens.index') }}">
                <i class="material-icons">toll</i>
                <p>{{ __('Tokens') }}</p>
            </a>
        </li>
        <li class="nav-item{{ $activePage == 'level' ? ' active' : '' }}">
        ...
        <li class="nav-item{{ $activePage == 'wheelhouse' ? ' active' : '' }}">
            <a class="nav-link" href="{{ route('wheelhouses.index') }}">
        ...
        <li class="nav-item{{ $activePage == 'commission' ? ' active' : '' }}">
            <a class="nav-link" href="{{route('commissions.index')}}">
                <i class="material-icons">arrow_circle</i>
                <p>{{ __('Commission') }}</p>
            </a>
        </li>
...
{{--            <ul class="nav">--}}
{{--              <li class="nav-item{{ $activePage == 'wheelhouse' ? ' active' : '' }}">--}}
{{--                <a class="nav-link" href="/wheelhouse">--}}
...
{{--                <a class="nav-link" href="/c_wheelhouse">--}}
...
{{--                            </a>--}}
{{--                        </li>--}}
{{--                        <li class="nav-item{{ $activePage == 'available_token' ? ' active' : '' }}">--}}
{{--                            <a class="nav-link" href="{{route('donation.mark-received')}}">--}}
{{--                                <span class="sidebar-mini"></span>--}}
...
{{--                                <span class="sidebar-mini"></span>--}}
{{--                                <span class="sidebar-normal"> {{ __('Token history') }} </span>--}}
{{--                            </a>--}}
{{--                        </li>--}}
{{--                    </ul>--}}
{{--                </div>--}}
